...
const QuizScreen = () => {
  ...
  useEffect(() => {
    if (selectedOptions.length > 0) {
      const areSelectedOptionsCorrect = selectedOptions.every(
        (optionIndex) => optionIndex === currentQuestion?.correctAnswerIndex
      );
  ...
  useEffect(() => {
    ...
    // Reset answer status and selected answer index
    setSelectedAnswerIndex(null);
    setAnswerStatus(null);
          ...
          {currentQuestion?.options.map((item, index) => (
             ...
             onPress={() => {
               ...
               if (updatedOptions.includes(index)) {
                 ...
                 const indexToRemove = updatedOptions.indexOf(index);
             ...
             style={
               selectedOptions.includes(index) && index === currentQuestion.correctAnswerIndex
                 ? {
                     flexDirection: "row",
                     alignItems: "center",
                     borderWidth: 0.5,
